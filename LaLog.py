...
class Login:
    def __init__(self,root):
        ...
        lbl_user=Label(Frame_login,text="Email/Phone:",font=("Monotype Corsiva",20),fg="white",bg="Grey").place(x=70,y=160)
    ...
    def login_function(self):
         ...
         elif self.txt_user.get()!=""or self.txt_user.get()!="8050174623"or"atulya@pytechno.com":
             messagebox.showinfo("Welcome","Done,now open Robot Verification App to verify and finish",parent=self.root)
